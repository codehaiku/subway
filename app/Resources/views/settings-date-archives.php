...
?>
    <p>
        ...
        <label>
            <input <?php checked( $subway_date_archives, 'public', true ); ?>
                    type="radio"
                    name="subway_date_archives"
                    id="subway_date_archives_public"
                    value="public"
            />
			<?php esc_html_e( 'Public', 'subway' ); ?>
        </label> &nbsp;
        <label>
            <input <?php checked( $subway_date_archives, 'private', true ); ?>
                    type="radio"
                    name="subway_date_archives"
                    id="subway_date_archives_private"
                    value="private"
            />
