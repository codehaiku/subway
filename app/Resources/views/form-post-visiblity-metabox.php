...
<div id="subway-roles-access-visibility-fields" class="hidden">
    ...
    <dl>
        <p>
            <label>
                <input value="block_content" <?php checked( 'block_content', $no_access_type, true ); ?> type="radio"
                       name="subway-visibility-settings-no-access-type"/>
            ...
            <div id="access-type-block-wrap">
                ...
                <dl>
                    <label>
                        ...
                        <textarea class="widefat" id="subway-visibility-settings-no-access-type-message"
                                  name="subway-visibility-settings-no-access-type-message"><?php echo wp_kses_post( $access_type_block_message ); ?></textarea>
                    </label>
                </dl>
                </p>
                <p class="howto">
    ...
    <dl>
        <p>
            <label>
                <input value="redirect" <?php checked( 'redirect', $no_access_type, true ); ?> type="radio"
                       name="subway-visibility-settings-no-access-type"/>
				<?php esc_html_e( 'Redirect (302) to', 'subway' ); ?>
                <a target="_blank" href="<?php echo esc_url( $options->get_redirect_url() ); ?>"
                   title="<?php esc_attr_e( 'Login Page', 'subway' ); ?>">
